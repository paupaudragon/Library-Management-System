...
public partial class Team28LibraryContext : DbContext
{
    public Team28LibraryContext()
    {
    }

    public Team28LibraryContext(DbContextOptions<Team28LibraryContext> options)
        : base(options)
    {
    }
